...
const ArticlesCont = ({ frogArticle, querys, userInfo }: Props) => {
  ...
  const _markingShow =
    userInfo?.customerId && userInfo?.membership?.templateLevel
      ? false
      : markingShow;
  return (
    <>
      <div className="justify-center pad:flex pc:flex mo:block article-content mo:py-[20px] px-[12px] bg-[#fff]">
        <div className="pad:flex pc:flex mo:block pad:w-[1200px] pc:w-[1200px] pc:mt-[48px]">
          <div className="pc:w-[calc(1200px-378px)] mo:w-[100%] pad:w-[100%] pad:mr-[20px] ">
            <div className="pc:pr-[20px]">
              <div>
                <h1 className="content-title !text-[30px] !m-[0] mo:!text-[20px] font-[700] ">
                  {frogArticle?.frogArticleTitle}
                </h1>
                ...
                <div
                  className={`${
                    _markingShow ? "max-h-[100vh] overflow-hidden" : ""
                  }`}
                >
                  {/* 新版编辑器 */}
                  ...
                  {!isCkbEditor && (
                    <div
                      ...
                      className={`media-help-artical-content ${
                        _markingShow ? `h-[100vh] overflow-hidden` : ""
                      } ${isCkbEditor ? "hidden" : ""} `}
          ...
          <div className="pc:w-[370px] shrink-0 mo:w-[100%] pad:w-[280px] ">
            ...
            {isCkbEditor && (
              <div className="mt-[20px] sticky top-[166px] pad:!top-[50px]">
                <div className="mo:hidden">
                  <LexicalTableOfContentsRightSide
                    title={frogArticle?.frogArticleTitle!}
                  />
                </div>
                <FixedBanner />
              </div>
      ...
      <div className="mo:hidden">{markingShow && <Marking />}</div>
    </>
  );
};

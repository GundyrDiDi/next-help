...
const getMetaConf = (lang: Local) => {
    const conf: Record<Local, Metadata> = {
        [Local.JA]: {
            ...
            description: '中国輸入代行・中国仕入れなら国際送料・買い付け手数料が業界最安値のTHE CKBへ。日本品質レベルのサポートと検品で安心。中国輸入で商品を選んだ後の面倒な作業（価格交渉、仕入れ、商品梱包、在庫管理、FBA直送）を全て代行します。アリババ・タオバオでのアパレル仕入れ・個人輸入など中国輸入代行業者をお探しの方はお任せください。',
        },
        [Local.KO]: {
            title: '',
        },

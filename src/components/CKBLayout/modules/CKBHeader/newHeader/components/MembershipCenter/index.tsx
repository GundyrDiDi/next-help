...
const membershipLevel = (props: MembershipProps) => {
    ...
    const existsMemshipDom = {
        ...
        style: {
            ...
            padding: 0,
            backgroundImage: `url(${
                vipLevelImg[membership?.templateLevel || 1]
            })`,
                        ...
                        <ul className="explain mt-[15px]">
                            {membershipExplain.map((item, index) => {
                                return (
                                    <li
                                        key={index}
                                        className="list flex items-center"
                                    >
                                        <img
        ...
        <div className="membershipCenter">
            ...
            >
                <div className={styles.item}>
                    <div className={classNames('relative', styles.icon)}>
                        {/* <IconVIPLogo /> */}
                        <img
                            src="https://static-s.theckb.com/BusinessMarket/OEM/vipCenter.png"
                            alt=""
                            width={24}
                            height={24}
                        />
